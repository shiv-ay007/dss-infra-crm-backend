...
export const createLeadProject = asyncHandler(async (req, res) => {
  ...
  const projectPayload = {
    ...
    businessType: Array.isArray(businessType) ? businessType.filter(Boolean).join(", ") : (businessType || "Information Technology"),
    workCategory: Array.isArray(workCategory) ? workCategory.filter(Boolean).join(", ") : (workCategory || businessType || "Design"),
    ...
    projectDetailFiles: Array.isArray(req.body.projectDetailFiles) ? req.body.projectDetailFiles : [],
    transferRemark: transferRemark?.trim() || "",
    remarksFiles: Array.isArray(req.body.remarksFiles) ? req.body.remarksFiles : [],
